...
SWIFT_CLASS("_TtC17SeosMobileKeysSDK11ApduCommand")
...
SWIFT_CLASS("_TtC17SeosMobileKeysSDK23ApduCommandGetChallenge")
@interface ApduCommandGetChallenge : ApduCommand
@end


SWIFT_CLASS("_TtC17SeosMobileKeysSDK17ApduCommandParser")
@interface ApduCommandParser : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC17SeosMobileKeysSDK18ApduCommandPutData")
@interface ApduCommandPutData : ApduCommand
@end


SWIFT_CLASS("_TtC17SeosMobileKeysSDK19ApduCommandSequence")
@interface ApduCommandSequence : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC17SeosMobileKeysSDK12ApduResponse")
...
SWIFT_CLASS("_TtC17SeosMobileKeysSDK24ApduResponseGetChallenge")
@interface ApduResponseGetChallenge : ApduResponse
@end


SWIFT_CLASS("_TtC17SeosMobileKeysSDK32ApduResponseMutualAuthentication")
@interface ApduResponseMutualAuthentication : ApduResponse
@end


SWIFT_CLASS("_TtC17SeosMobileKeysSDK20ApduResponseSequence")
@interface ApduResponseSequence : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC17SeosMobileKeysSDK15KeyPairFrontend")
@interface KeyPairFrontend : NSObject
- (NSData * _Nonnull)createKeypairTest SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nonnull)createKeypairTestAllFunctions SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=10.3);
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC17SeosMobileKeysSDK29MobileKeysManagerSwiftWrapper")
@interface MobileKeysManagerSwiftWrapper : NSObject <MobileKeysManagerDelegate>
/// Capture Callbacks for asynchronous calls
- (void)mobileKeysDidStartup;
- (void)mobileKeysDidFailToStartup:(NSError * _Nonnull)error;
- (void)mobileKeysDidSetupEndpoint;
- (void)mobileKeysDidFailToSetupEndpoint:(NSError * _Nonnull)error;
- (void)mobileKeysDidUpdateEndpoint;
- (void)mobileKeysDidFailToConnectToReader:(MobileKeysReader * _Nonnull)reader openingType:(MobileKeysOpeningType)type openingStatus:(MobileKeysOpeningStatusType)status;
- (void)mobileKeysDidFailToUpdateEndpoint:(NSError * _Nonnull)error;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@protocol MobileKeysMotionRecognizerDelegate;
@class CMMotionManager;

SWIFT_CLASS("_TtC17SeosMobileKeysSDK20MobileKeysSensorData")
@interface MobileKeysSensorData : NSObject <MotionRecognizerProtocol>
@property (nonatomic) BOOL enableMLmodel;
- (nonnull instancetype)initWithCallback:(id <MobileKeysMotionRecognizerDelegate> _Nonnull)callback motionManager:(CMMotionManager * _Nonnull)motionManager url:(NSURL * _Nonnull)url OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCallback:(id <MobileKeysMotionRecognizerDelegate> _Nonnull)callback motionManager:(CMMotionManager * _Nonnull)motionManager OBJC_DESIGNATED_INITIALIZER;
- (void)startTrackingRotation;
- (void)stopTrackingRotation;
- (void)pauseTrackingRotation;
- (void)resumeTrackingRotation;
- (BOOL)isTrackingRotation SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, OpeningType, closed) {
  OpeningTypeTap = 0,
...
typedef SWIFT_ENUM(NSInteger, ReaderCapabilities, closed) {
  ReaderCapabilitiesAdvertising = 0,
  ReaderCapabilitiesConnecting = 1,
};

typedef SWIFT_ENUM(NSInteger, ReaderModuleType, closed) {
...
typedef SWIFT_ENUM(NSInteger, TriggerStatus, closed) {
