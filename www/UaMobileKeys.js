...
UaMobileKeys.prototype.androidCheckBtPermissionStatus = function(arg0, success, error) {
    this.pInvoke("androidCheckBtPermissionStatus", arg0, success, error);
};

UaMobileKeys.prototype.getUsefulEndpointInfo = function(arg0, success, error) {
